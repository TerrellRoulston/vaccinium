#!/bin/bash
#SBATCH --array=0-25              # Array size (26 tasks, 0-25)
...
species=("ang" "arb" "bor" "ces" "cor" "cra" "dar" "del" "ery" "hir" "mac" "mem" "mys" "myr" "mtu" "ova" "ovt" "oxy" "pal" "par" "sco" "sta" "ten" "uli" "vir" "vid")
