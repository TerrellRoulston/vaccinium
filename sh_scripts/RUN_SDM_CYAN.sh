#!/bin/bash
#SBATCH --array=0-14                # Array size (15 tasks, 0-14, sect cyanococcus spp)
...
species=("ash" "cor" "cot" "ell"  "fus" "sim" "vir" "ang" "bor" "dar" "hir" "myr" "mys" "pal" "ten")
...
Rscript run_vac_maxent_cyan.R $species_name
