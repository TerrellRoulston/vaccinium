...
species_list <- list(
  "ash" = list(
    bg_file  = "/project/6074193/mig_lab/vac_sdm/bg_data/wclim_occ_ash_thin_bgpts.rds",
    occ_file = "/project/6074193/mig_lab/vac_sdm/occ_data/occ_ash_thin.rds",
    env_file = "/project/6074193/mig_lab/vac_sdm/wclim_data/wclim_occ_ash_thin_bgmask.tif"
  ),
  "cor" = list(
  ...
  "cot" = list(
    bg_file  = "/project/6074193/mig_lab/vac_sdm/bg_data/wclim_occ_cot_thin_bgpts.rds",
    occ_file = "/project/6074193/mig_lab/vac_sdm/occ_data/occ_cot_thin.rds",
    env_file = "/project/6074193/mig_lab/vac_sdm/wclim_data/wclim_occ_cot_thin_bgmask.tif"
  ),
  "ell" = list(
    bg_file  = "/project/6074193/mig_lab/vac_sdm/bg_data/wclim_occ_ell_thin_bgpts.rds",
    occ_file = "/project/6074193/mig_lab/vac_sdm/occ_data/occ_ell_thin.rds",
    env_file = "/project/6074193/mig_lab/vac_sdm/wclim_data/wclim_occ_ell_thin_bgmask.tif"
  ),
  "fus" = list(
    bg_file  = "/project/6074193/mig_lab/vac_sdm/bg_data/wclim_occ_fus_thin_bgpts.rds",
    occ_file = "/project/6074193/mig_lab/vac_sdm/occ_data/occ_fus_thin.rds",
    env_file = "/project/6074193/mig_lab/vac_sdm/wclim_data/wclim_occ_fus_thin_bgmask.tif"
  ),
  "sim" = list(
    bg_file  = "/project/6074193/mig_lab/vac_sdm/bg_data/wclim_occ_sim_thin_bgpts.rds",
    occ_file = "/project/6074193/mig_lab/vac_sdm/occ_data/occ_sim_thin.rds",
    env_file = "/project/6074193/mig_lab/vac_sdm/wclim_data/wclim_occ_sim_thin_bgmask.tif"
  ),
  "vir" = list(
