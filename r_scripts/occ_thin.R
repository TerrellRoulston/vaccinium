...
saveRDS(occ_ang_thin, file = './occ_data/thin/occ_ang_thin.Rdata')
saveRDS(occ_arb_thin, file = './occ_data/thin/occ_arb_thin.Rdata')
saveRDS(occ_bor_thin, file = './occ_data/thin/occ_bor_thin.Rdata')
saveRDS(occ_ces_thin, file = './occ_data/thin/occ_ces_thin.Rdata')
saveRDS(occ_cor_thin, file = './occ_data/thin/occ_cor_thin.Rdata')
saveRDS(occ_cra_thin, file = './occ_data/thin/occ_cra_thin.Rdata')
saveRDS(occ_dar_thin, file = './occ_data/thin/occ_dar_thin.Rdata')
saveRDS(occ_del_thin, file = './occ_data/thin/occ_del_thin.Rdata')
saveRDS(occ_ery_thin, file = './occ_data/thin/occ_ery_thin.Rdata')
saveRDS(occ_hir_thin, file = './occ_data/thin/occ_hir_thin.Rdata')
saveRDS(occ_mac_thin, file = './occ_data/thin/occ_mac_thin.Rdata')
saveRDS(occ_mem_thin, file = './occ_data/thin/occ_mem_thin.Rdata')
saveRDS(occ_mtu_thin, file = './occ_data/thin/occ_mtu_thin.Rdata')
saveRDS(occ_myr_thin, file = './occ_data/thin/occ_myr_thin.Rdata')
saveRDS(occ_mys_thin, file = './occ_data/thin/occ_mys_thin.Rdata')
saveRDS(occ_ova_thin, file = './occ_data/thin/occ_ova_thin.Rdata')
saveRDS(occ_ovt_thin, file = './occ_data/thin/occ_ovt_thin.Rdata')
saveRDS(occ_oxy_thin, file = './occ_data/thin/occ_oxy_thin.Rdata')
saveRDS(occ_pal_thin, file = './occ_data/thin/occ_pal_thin.Rdata')
saveRDS(occ_par_thin, file = './occ_data/thin/occ_par_thin.Rdata')
saveRDS(occ_sco_thin, file = './occ_data/thin/occ_sco_thin.Rdata')
saveRDS(occ_sta_thin, file = './occ_data/thin/occ_sta_thin.Rdata')
saveRDS(occ_ten_thin, file = './occ_data/thin/occ_ten_thin.Rdata')
saveRDS(occ_uli_thin, file = './occ_data/thin/occ_uli_thin.Rdata')
saveRDS(occ_vid_thin, file = './occ_data/thin/occ_vid_thin.Rdata')
saveRDS(occ_sha_thin, file = './occ_data/thin/occ_sha_thin.Rdata')
