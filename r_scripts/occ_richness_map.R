...
wclimNA <- readRDS('./wclim_data/wclim_NA/wclim.rds')
rast_template <- wclimNA[1] # grab the first layer of the wclim data as a template for rasterizing the occ vectors


# Load occ data -----------------------------------------------------------
occ_angThin <- readRDS('./occ_data/thinned/occ_angThin.rds')
occ_arbThin <- readRDS('./occ_data/thinned/occ_arbThin.rds')
occ_borThin <- readRDS('./occ_data/thinned/occ_borThin.rds')
occ_cesThin <- readRDS('./occ_data/thinned/occ_cesThin.rds')
occ_corThin <- readRDS('./occ_data/thinned/occ_corThin.rds')
occ_craThin <- readRDS('./occ_data/thinned/occ_craThin.rds')
occ_darThin <- readRDS('./occ_data/thinned/occ_darThin.rds')
occ_delThin <- readRDS('./occ_data/thinned/occ_delThin.rds')
occ_eryThin <- readRDS('./occ_data/thinned/occ_eryThin.rds')
occ_hirThin <- readRDS('./occ_data/thinned/occ_hirThin.rds')
occ_macThin <- readRDS('./occ_data/thinned/occ_macThin.rds')
occ_memThin <- readRDS('./occ_data/thinned/occ_memThin.rds')
occ_mtuThin <- readRDS('./occ_data/thinned/occ_mtuThin.rds')
occ_myrThin <- readRDS('./occ_data/thinned/occ_myrThin.rds')
occ_mysThin <- readRDS('./occ_data/thinned/occ_mysThin.rds')
occ_ovaThin <- readRDS('./occ_data/thinned/occ_ovaThin.rds')
occ_ovtThin <- readRDS('./occ_data/thinned/occ_ovtThin.rds')
occ_oxyThin <- readRDS('./occ_data/thinned/occ_oxyThin.rds')
occ_palThin <- readRDS('./occ_data/thinned/occ_palThin.rds')
occ_parThin <- readRDS('./occ_data/thinned/occ_parThin.rds')
occ_scoThin <- readRDS('./occ_data/thinned/occ_scoThin.rds')
occ_staThin <- readRDS('./occ_data/thinned/occ_staThin.rds')
occ_tenThin <- readRDS('./occ_data/thinned/occ_tenThin.rds')
occ_uliThin <- readRDS('./occ_data/thinned/occ_uliThin.rds')
occ_vidThin <- readRDS('./occ_data/thinned/occ_vidThin.rds')
occ_virThin <- readRDS('./occ_data/thinned/occ_virThin.rds')
